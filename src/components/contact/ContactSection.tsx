...
export function ContactSection() {
  return (
    ...
    >
      <div aria-hidden className="pointer-events-none absolute right-[8%] top-[15%] h-[400px] w-[500px] rounded-full opacity-[0.06]"
        style={{ background: "radial-gradient(circle, rgba(169,138,213,0.3) 0%, transparent 70%)" }}
      />
      ...
      <svg aria-hidden className="pointer-events-none absolute -right-12 top-[20%] opacity-[0.03]" width="420" height="420" viewBox="0 0 24 24">
        ...
        <div className="grid gap-y-14 lg:grid-cols-12 lg:gap-x-8 xl:gap-x-10">
          ...
          <div className="relative lg:col-span-7 lg:col-start-6 lg:-mt-6">
            <motion.div
              ...
              style={{ background: "linear-gradient(180deg, rgba(214,160,62,0) 0%, #D6A03E 22%, #E9C77F 70%, rgba(233,199,127,0) 100%)" }}
            />

            <motion.div
              aria-hidden
              variants={fadeIn(0.6, 0.35)}
              initial="hidden"
              whileInView="visible"
              viewport={defaultViewport}
            ...
            <div className="relative rounded-[24px] border border-[rgba(46,21,87,0.1)] bg-white p-8 shadow-[0_20px_55px_rgba(46,21,87,0.1)] lg:p-10 xl:p-12">
              <motion.div
                aria-hidden
                variants={fadeIn(0.55, 0.4)}
                initial="hidden"
                whileInView="visible"
                viewport={defaultViewport}
