export const contactData = {
  ...
  headline: {
    lineOne: "Let's build your",
    lineTwoAccent: "workforce.",
  },
  ...
  form: {
    ...
    supportingLine: "A few details help us understand the role, scale and timeline of your requirement.",
    submitLabel: "Submit Requirement",
    consentText: "By submitting this form, you agree to our Privacy Policy.",
    detailsPlaceholder: "Tell us about the roles, skills, locations, shifts, employment type and expected start date.",
  },
};
